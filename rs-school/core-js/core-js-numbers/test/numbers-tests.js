...
describe('core-js-numbers', () => {
  ...
  it.optional('isNumber returns a boolean value indicating whether a number or not', () => {
    assert.equal(tasks.isNumber(Infinity), false, 'value Infinity is not a number');
    assert.equal(tasks.isNumber(NaN), false, 'value NaN is not a number');
    assert.equal(tasks.isNumber(0), true, 'value 0 is a number');
    assert.equal(tasks.isNumber('a' / 1), false, "value 'a'/1 is not a number");
  ...
  it.optional('getRandomInteger returns a random integer in the range from min to max', () => {
    for (let i = 0; i < 10; i += 1) {
      ...
      assert.equal(Number.isInteger(result), true, `the ${result} is not an integer`);
      assert.equal(
  ...
  it.optional('getHypotenuse returns the length of the hypotenuse of a right triangle', () => {
    ...
    assert.equal(tasks.getHypotenuse(Number.MAX_VALUE, 6), 1.7976931348623157e308);
  });
...
describe('core-js-numbers-tasks optimal implementation', () => {
  ...
  it.optional('optimal implementation of numberToStringInBase', function test() {
  ...
  it.optional('optimal implementation of roundToSmallestInteger', function test() {
  ...
  it.optional('optimal implementation of roundToLargestInteger', function test() {
  ...
  it.optional('optimal implementation of roundToNearestInteger', function test() {
  ...
  it.optional('optimal implementation of getIntegerPartNumber', function test() {
