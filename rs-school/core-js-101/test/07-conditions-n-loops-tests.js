...
describe('08-conditions-n-loops-tasks', () => {
  it.optional('getFizzBuzz should return the output value according specification', () => {
    [
      1, 2, 4, 7, 8, 11, 13, 14, 16, 17, 19, 22, 23, 26, 28, 29, 31, 32, 34, 37, 38, 41, 43, 44, 47, 49, 52,
      53, 56, 58, 59, 61, 62, 64, 67, 68, 71, 73, 74, 76, 77, 79, 82, 83, 86, 88, 89, 91, 92, 94, 97, 98,
    ].forEach((num) => {
  ...
  it.optional('isCreditCardNumber should validate CCN', () => {
    ...
    [4571234567890111, 5436468789016589, 4916123456789012, 371449635398430, 9112893456789010].forEach(
      (ccn) => {
